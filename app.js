...
(function(){
  ...
  const resultsEncourage=document.getElementById('resultsEncourage');
  const rateAnotherBtn=document.getElementById('rateAnotherBtn');
  const autoCountdown=document.getElementById('autoCountdown');
  const resultsSummaryCount=document.getElementById('resultsSummaryCount');
  ...
  function updateAdminStats(){
    ...
    if(adminProduct)adminProduct.textContent=titles.join(', ');
